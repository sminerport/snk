...
/* harmony import */ var _sample__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sample */ "./sample.ts");
/* harmony import */ var _snk_solver_outside__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @snk/solver/outside */ "../solver/outside.ts");




const { canvas, ctx, draw, highlightCell } = (0,_canvas__WEBPACK_IMPORTED_MODULE_1__.createCanvas)(_sample__WEBPACK_IMPORTED_MODULE_2__.grid);
document.body.appendChild(canvas);
let k = 0;
const onChange = () => {
    ctx.clearRect(0, 0, 9999, 9999);
    draw(_sample__WEBPACK_IMPORTED_MODULE_2__.grid, [], []);
    const outside = (0,_snk_solver_outside__WEBPACK_IMPORTED_MODULE_3__.createOutside)(_sample__WEBPACK_IMPORTED_MODULE_2__.grid, k);
    for (let x = outside.width; x--;)
        for (let y = outside.height; y--;)
            if ((0,_snk_solver_outside__WEBPACK_IMPORTED_MODULE_3__.isOutside)(outside, x, y))
                highlightCell(x, y);
};
onChange();
