...
/* harmony import */ var _sample__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sample */ "./sample.ts");
/* harmony import */ var _snk_solver_getPathToPose__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @snk/solver/getPathToPose */ "../solver/getPathToPose.ts");
...
const target = (0,_snk_types_snake__WEBPACK_IMPORTED_MODULE_2__.createSnakeFromCells)((0,_snk_types_snake__WEBPACK_IMPORTED_MODULE_2__.snakeToCells)(_sample__WEBPACK_IMPORTED_MODULE_3__.snake).map((p) => ({ ...p, x: p.x - 1 })));
let chain = [_sample__WEBPACK_IMPORTED_MODULE_3__.snake, ...(0,_snk_solver_getPathToPose__WEBPACK_IMPORTED_MODULE_4__.getPathToPose)(_sample__WEBPACK_IMPORTED_MODULE_3__.snake, target)];
let i = 0;
const onChange = () => {
    ctx.clearRect(0, 0, 9999, 9999);
    draw(_sample__WEBPACK_IMPORTED_MODULE_3__.grid, chain[i], []);
    chain
        .map(_snk_types_snake__WEBPACK_IMPORTED_MODULE_2__.snakeToCells)
        .flat()
