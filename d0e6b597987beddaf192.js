...
/* harmony import */ var _snk_types_snake__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @snk/types/snake */ "../types/snake.ts");
/* harmony import */ var _sample__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sample */ "./sample.ts");
/* harmony import */ var _snk_solver_getPathTo__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @snk/solver/getPathTo */ "../solver/getPathTo.ts");





const { canvas, ctx, draw, getPointedCell, highlightCell } = (0,_canvas__WEBPACK_IMPORTED_MODULE_1__.createCanvas)(_sample__WEBPACK_IMPORTED_MODULE_3__.grid);
canvas.style.pointerEvents = "auto";
let snake = (0,_snk_types_snake__WEBPACK_IMPORTED_MODULE_2__.copySnake)(_sample__WEBPACK_IMPORTED_MODULE_3__.snake);
let chain = [snake];
canvas.addEventListener("mousemove", (e) => {
    const { x, y } = getPointedCell(e);
    chain = [...((0,_snk_solver_getPathTo__WEBPACK_IMPORTED_MODULE_4__.getPathTo)(_sample__WEBPACK_IMPORTED_MODULE_3__.grid, snake, x, y) || []), snake].reverse();
