...
/* harmony import */ var _snk_solver_getBestRoute__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @snk/solver/getBestRoute */ "../solver/getBestRoute.ts");
/* harmony import */ var _snk_types_grid__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @snk/types/grid */ "../types/grid.ts");
/* harmony import */ var _sample__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sample */ "./sample.ts");
/* harmony import */ var _snk_solver_step__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @snk/solver/step */ "../solver/step.ts");
...
const chain = (0,_snk_solver_getBestRoute__WEBPACK_IMPORTED_MODULE_2__.getBestRoute)(_sample__WEBPACK_IMPORTED_MODULE_4__.grid, _sample__WEBPACK_IMPORTED_MODULE_4__.snake);
//
// draw
let k = 0;
const { canvas, draw } = (0,_canvas__WEBPACK_IMPORTED_MODULE_1__.createCanvas)(_sample__WEBPACK_IMPORTED_MODULE_4__.grid);
document.body.appendChild(canvas);
const onChange = () => {
    const gridN = (0,_snk_types_grid__WEBPACK_IMPORTED_MODULE_3__.copyGrid)(_sample__WEBPACK_IMPORTED_MODULE_4__.grid);
    const stack = [];
    for (let i = 0; i <= k; i++)
        (0,_snk_solver_step__WEBPACK_IMPORTED_MODULE_5__.step)(gridN, stack, chain[i]);
