...
const createCanvas = ({ width, height, }) => {
    ...
    const draw = (grid, snake, stack) => {
        ...
        (0,_snk_draw_drawWorld__WEBPACK_IMPORTED_MODULE_0__.drawWorld)(ctx, grid, null, snake, stack, drawOptions);
    };
    const drawLerp = (grid, snake0, snake1, stack, k) => {
        ctx.clearRect(0, 0, 9999, 9999);
        (0,_snk_draw_drawWorld__WEBPACK_IMPORTED_MODULE_0__.drawLerpWorld)(ctx, grid, null, snake0, snake1, stack, k, drawOptions);
    };
...
module.exports = /*#__PURE__*/JSON.parse('["interactive","getBestRoute","getBestTunnel","outside","getPathToPose","getPathTo","svg"]');
...
/*!*******************************!*\
  !*** ./demo.getBestTunnel.ts ***!
  \*******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _menu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./menu */ "./menu.ts");
/* harmony import */ var _canvas__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./canvas */ "./canvas.ts");
/* harmony import */ var _snk_types_snake__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @snk/types/snake */ "../types/snake.ts");
/* harmony import */ var _sample__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sample */ "./sample.ts");
/* harmony import */ var _snk_types_grid__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @snk/types/grid */ "../types/grid.ts");
/* harmony import */ var _snk_solver_getBestTunnel__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @snk/solver/getBestTunnel */ "../solver/getBestTunnel.ts");
/* harmony import */ var _snk_solver_outside__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @snk/solver/outside */ "../solver/outside.ts");
var _a, _b;
...
const { canvas, ctx, draw, highlightCell } = (0,_canvas__WEBPACK_IMPORTED_MODULE_1__.createCanvas)(_sample__WEBPACK_IMPORTED_MODULE_3__.grid);
document.body.appendChild(canvas);
const ones = [];
for (let x = 0; x < _sample__WEBPACK_IMPORTED_MODULE_3__.grid.width; x++)
    for (let y = 0; y < _sample__WEBPACK_IMPORTED_MODULE_3__.grid.height; y++)
        if ((0,_snk_types_grid__WEBPACK_IMPORTED_MODULE_4__.getColor)(_sample__WEBPACK_IMPORTED_MODULE_3__.grid, x, y) === 1)
            ones.push({ x, y });
const tunnels = ones.map(({ x, y }) => ({
    x,
    y,
    tunnel: (0,_snk_solver_getBestTunnel__WEBPACK_IMPORTED_MODULE_5__.getBestTunnel)(_sample__WEBPACK_IMPORTED_MODULE_3__.grid, (0,_snk_solver_outside__WEBPACK_IMPORTED_MODULE_6__.createOutside)(_sample__WEBPACK_IMPORTED_MODULE_3__.grid), x, y, 3, (0,_snk_types_snake__WEBPACK_IMPORTED_MODULE_2__.getSnakeLength)(_sample__WEBPACK_IMPORTED_MODULE_3__.snake)),
}));
const onChange = () => {
    ...
    draw(_sample__WEBPACK_IMPORTED_MODULE_3__.grid, _sample__WEBPACK_IMPORTED_MODULE_3__.snake, []);
...
inputK.addEventListener("input", () => {
    var _a, _b;
    inputI.value = 0;
    inputI.max = (((_b = (_a = tunnels[+inputK.value]) === null || _a === void 0 ? void 0 : _a.tunnel) === null || _b === void 0 ? void 0 : _b.length) || 1) - 1;
    onChange();
});
